...
class UserGrounder(Grounder):
    ...
    def ground(self, imagefile, segments, _=None):
        ...
        :return:
        """
        print '''For each shown segment, please write the character that it represents, or spacebar if it's '''\
              '''not a character. To undo a classification, press backspace. Press ESC when completed, '''\
              '''arrow keys to move'''
        i = 0
