...
class OCR(object):
    ...
    def ocr(self, image_file, show_steps=False):
        ...
        :param image_file: must be a files.ImageFile object
        :param show_steps: defaults to False, if True makes the program display
                           the steps involved by calling segmenter.display()
        :return: None
        """
